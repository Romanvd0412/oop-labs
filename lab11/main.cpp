...
int main() {
    ...
    conductors[2]->setMaxFrequency(250e12);
    conductors[1]->setManufacturer("User Manufactured");
    
    cout << "\nDisplaying Info (using virtual functions):" << endl;
    ...
    ConductorProcessor processor;
    processor.calculateAndDisplayStats(conductors);
